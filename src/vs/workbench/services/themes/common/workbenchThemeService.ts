...
export const COLOR_THEME_DARK_INITIAL_COLORS = { // Void changed this to match dark+
	'activityBar.activeBorder': '#0DB9D7',
	...
	'statusBar.background': '#0DB9D7',
	'statusBar.border': '#2a2a2a',
	'statusBar.foreground': '#000000',
	'statusBar.noFolderBackground': '#0DB9D7',
	'tab.activeBackground': '#2a2a2a',
	'tab.activeBorder': '#0DB9D7',
	'tab.activeBorderTop': '#0DB9D7',
	'tab.activeForeground': '#FFFFFF',
	'tab.border': '#2a2a2a',
	'textLink.foreground': '#0DB9D7',
...
export const COLOR_THEME_LIGHT_INITIAL_COLORS = {
	...
	'titleBar.activeForeground': '#090e1a',
